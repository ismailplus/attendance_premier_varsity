...
$allTeachers = $subjects->getAllTeachers();
$allAssignSubjects = $subjects->getAllSubjectAssign();
//
        ...
        <div class="wall col-12" style="margin-bottom: -50px;">
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php if(!empty($allAssignSubjects))foreach ($allAssignSubjects as $subject){ ?>
                                    <tr>
                ...
                <div class="col-5">
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="store_assign_subject.php">
                                <div class="row">
                                    <div class="col-12">
