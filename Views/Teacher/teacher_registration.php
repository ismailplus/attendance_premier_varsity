            ...
            <div class="card">
                ...
                <div class="card-body mx-3">
                    ...
                    <div class="text-center">
                        <h3 class="pink-text mb-5"><strong>Teacher Registration</strong></h3>
                    </div>

                    <!--Body-->
                    <form method="post" action="store_teacher.php">
                        <div class="row">
                            <div class="col-12">
                                <div class="md-form">
                                    <input
                        ...
                        <div class="row">
                            <div class="col-6 offset-3 mt-1">
                                <span> Have an Account?</span><a href="teacher_login.php">Login Now</a>
                            </div>
                        </div>
                    </form>
                </div>
